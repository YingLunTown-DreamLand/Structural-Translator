...
for i in filePath:
    ...
    outputLocation = os.path.normpath(os.path.join(outputPath,i.replace(searchPath + '/','',1))).replace('\\','/')
...
logOutputLocation = os.path.normpath(os.path.join(outputPath,'UpgradeExecuteCommand_log.json')).replace('\\','/')
