...
def main():
    ...
    if name == 'minecraft:stone_block_slab':
        type = share.ans["stone_slab_type"]
        top_slot_bit = share.ans["top_slot_bit"]
        #
    ...
    if name == 'minecraft:stone_block_slab4':
        type = share.ans["stone_slab_type_4"]
        top_slot_bit = share.ans["top_slot_bit"]
        #
        if type == 'stone':
            if top_slot_bit == 0:
    ...
    if name == 'minecraft:stone_block_slab2':
        type = share.ans["stone_slab_type_2"]
        top_slot_bit = share.ans["top_slot_bit"]
        #
    ...
    if name == 'minecraft:stone_block_slab3':
        type = share.ans["stone_slab_type_3"]
        top_slot_bit = share.ans["top_slot_bit"]
        #
        if type == 'granite':
            if top_slot_bit == 0:
